...
class OutlineButtonV2 extends MaterialButton {
  ...
  Widget build(BuildContext context) {
    ...
    return _OutlineButton(
      ...
      textTheme: textTheme,
      textColor: color ?? ColorConstants.ACCENT_DARK,
      disabledTextColor: buttonTheme.getDisabledTextColor(this),
      // color: color,
      highlightColor: (color ?? ColorConstants.ACCENT_DARK).withOpacity(0.16),
      splashColor: buttonTheme.getSplashColor(this),
      highlightElevation: buttonTheme.getHighlightElevation(this),
      borderSide:
          borderSide ?? BorderSide(color: color ?? ColorConstants.ACCENT_DARK),
      disabledBorderColor: disabledBorderColor,
      highlightedBorderColor: color ?? ColorConstants.ACCENT_DARK,
...
class _OutlineButtonWithIcon extends OutlineButtonV2
