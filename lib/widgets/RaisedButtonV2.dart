// CREATED AND MODIFIED BY PARTH PATEL on 19/06/2019
...
class RaisedButtonV2 extends MaterialButton {
  ...
  Widget build(BuildContext context) {
    ...
    return RawMaterialButton(
      ...
      fillColor: color ?? ColorConstants.ACCENT_DARK,
      textStyle: theme.textTheme.button.copyWith(color: textColor ?? Colors.white),
      highlightColor: buttonTheme.getHighlightColor(this),
      splashColor: buttonTheme.getSplashColor(this),
      elevation: buttonTheme.getElevation(this),
      highlightElevation: buttonTheme.getHighlightElevation(this),
      disabledElevation: buttonTheme.getDisabledElevation(this),
      padding: buttonTheme.getPadding(this), // EdgeInsets.symmetric(horizontal: 42, vertical:12),
...
/// The type of of RaisedButtons created with [RaisedButtonV2.icon].
///
/// This class only exists to give RaisedButtons created with [RaisedButtonV2.icon]
/// a distinct class for the sake of [ButtonTheme]. It can not be instantiated.
class _RaisedButtonWithIcon extends RaisedButtonV2
